...
public static void main(String[] args){
  ...
  System.out.println("");
  System.out.println("This is a random number generator that will then place these random results in order in an array, for this next section please input the amount of numbers to generate");
  System.out.println("");
    int n = sc.nextInt();
  sc.close();
